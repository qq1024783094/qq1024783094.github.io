...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/posts/地塞米松': RouteRecordInfo<'/posts/地塞米松', '/posts/地塞米松', Record<never, never>, Record<never, never>>,
    '/posts/寄生虫': RouteRecordInfo<'/posts/寄生虫', '/posts/寄生虫', Record<never, never>, Record<never, never>>,
